...
class LochLomondEnv(discrete.DiscreteEnv):
    ...
    def __init__(self, problem_id=0, is_stochastic=True, reward_hole=0.0):
        ...
        # for the final submission in AI (H) this should be 8x8-base but you may want to start out with 4x4-base!
    ...
    def render(self, mode='human'):
        ...
        desc[row][col] = "X"
        # note: this does not work on all setups you can try to uncomment asnd 
        # see what happends (if it does work you'll see weird symbols)
